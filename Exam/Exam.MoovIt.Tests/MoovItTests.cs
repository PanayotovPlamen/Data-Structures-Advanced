...
public class Tests
{
    ...
    //[Test]
    //public void TestGetFavourites_WithEqualRoute_ShouldReturnTrue()
    //{
    //    Route route = new Route("Test1", 10D, 1, false, new List<string>(new string[] { "Sofia", "Plovdiv", "Stara Zagora", "Burgas" }));
    //    Route route2 = new Route("Test2", 20D, 1, true, new List<string>(new string[] { "Varna", "Pleven", "Veliko Turnovo", "Varna", "Burgas" }));
    //    Route route3 = new Route("Test3", 30D, 1, false, new List<string>(new string[] { "Sofia", "Pleven", "Veliko Turnovo", "Varna", "Burgas" }));
    //    Route route4 = new Route("Test4", 40D, 1, true, new List<string>(new string[] { "Petrich", "Pleven", "Veliko Turnovo", "Varna", "Burgas" }));
    //    Route route5 = new Route("Test5", 50D, 1, false, new List<string>(new string[] { "Sofia", "Pleven", "Veliko Turnovo", "Varna", "Burgas" }));
    ...
    //    var result = this.moovIt.GetFavoriteRoutes("Varna");
